"""
Django settings for kojo_43304 project.
...
WSGI_APPLICATION = 'kojo_43304.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "kojo_43304 API",
    "DESCRIPTION": "API documentation for kojo_43304 App",
    "VERSION": "v1",
}
